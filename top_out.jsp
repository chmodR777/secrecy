...
<form name="form_top" action="menu_out.jsp" method="post" target="leftFrame">
...
<table cellSpacing=0 cellPadding=0 width="100%" border=0>
	<tr>
		<td background="images/frame/top_01.jpg" height=70>&nbsp;</td>
	</tr>
</table>
<table cellSpacing=0 cellPadding=0 width="100%" border=0>
	<tr>
		...
		<table cellSpacing=0 cellPadding=0 align=right border=0>
			<tr>
				...
				<td width=40 nowrap><a href="out.htm" target=mainFrame>首页</a></td>
