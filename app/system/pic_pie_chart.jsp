...
<syntc:ScriptsCommon />
<syntc:TitleHeader header="综合统计图表 >> 饼状统计图" />
<syntc:FuncHeader header="饼状统计图" showall="yes"/>
<br>
...
<% if("2".equals(flag)){ %>
  <tr>
	<td class="input" colspan="4">
      <img alt="" src="<%=chartPath %>/PicPieChart.jpg">
    </td>
  </tr>
...
function compute(){
	if (checkSubmit()) {
		document.form1.action = "PicCakeChart.do?flag=2";
