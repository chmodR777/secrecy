...
<html>
<head><title>导入邮药信息</title></head>
<body topmargin=0 leftmargin=0>
<form name="form1" method="post" enctype="multipart/form-data" action="">
<syntc:ScriptsCommon />
<syntc:TitleHeader header="邮药信息管理 >> 导入邮药信息" />
<syntc:FuncHeader header="导入邮药信息" showall="yes"/>
<br>
...
function funImport() {
    if (checkSubmit()) {
    	...
    	document.form1.action = "MedicineImport.do?strMonth=" + strMonth;
