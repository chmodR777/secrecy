...
<syntc:ScriptsCommon />
<syntc:TitleHeader header="综合统计图表 >> 柱形统计图1" />
<syntc:FuncHeader header="柱形统计图1" showall="yes"/>
<br>
...
<% if("2".equals(flag)){ %>
  <tr>
	<td class="input" colspan="4">
      <img alt="" src="<%=chartPath %>/PicBarChart.jpg">
    </td>
  </tr>
<% } %>
</syntc:HtmlTable>
...
function compute(){
	if (checkSubmit()) {
		document.form1.action = "PicBarChart.do?flag=2";
