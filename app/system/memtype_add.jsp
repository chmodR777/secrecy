...
<html>
<head><title>会员类别新建页面</title></head>
<body topmargin=0 leftmargin=0 onload="initHTML();">
<form name="form1" method="post">
<syntc:ScriptsCommon />
<syntc:TitleHeader header="系统管理 >> 会员类别管理 >> 新建" />
<syntc:FuncHeader header="会员类别新建" showall="yes"/>
<br>
...
<syntc:HtmlTable>
  <tr>
	...
	<td class="input" width="30%">
      <input type="text" name="txtTYPE_NAME" len="64">
      <font color="red">*</font>
    </td>
	<td class="item" width="20%" nowrap>院方承担比例(%)：</td>
	<td class="input" width="30%">
      <input type="text" name="txtPERCENT" onkeypress="OnNumDotKeypress()" onfocus="this.style.imeMode='disabled'">
      <font color="red">*</font>
    </td>
  </tr>
  <tr>
	...
	<td class="input">
      <input type="text" name="txtSCORE" onkeypress="OnNumKeypress()" onfocus="this.style.imeMode='disabled'">
      <font color="red">*</font>
    </td>
...
function funSave() {
    if (checkSubmit()) {
        document.form1.action = "MemTypeAddSave.do";
