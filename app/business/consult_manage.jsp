...
%>
<syntc:TitleHeader header="咨询信息管理" />

<form name="form1" action="" method="post">
<syntc:ScriptsCommon />
<input type="hidden" name="state">
<input type="hidden" name="actname" value="ConsultManage.do">
<syntc:FuncHeader header="咨询信息管理" showall="yes"/>
<br>
...
<br>
<syntc:TableTitle header="咨询信息列表" >
<syntc:TableHeader />
<syntc:ButtonBase caption="导入咨询信息" width="75" onclick="funImportConsultInfo();" />
<syntc:TableFoot />
</syntc:TableTitle>   
      <syntc:HtmlTable>
        <tr class="title">
...
%>
        <tr>
          ...
          <td class="nm" nowrap><a href="#" onclick="funExportConsultInfo('<%=str_Month%>')">导出咨询信息</a></td>
        </tr>
<%		
	}
}
...
function funImportConsultInfo() {
	document.form1.action = "ConsultImport.do";
    document.form1.submit();
}

function funExportConsultInfo(month) {
	document.form1.action = "ConsultExport.do?month=" + month;
    document.form1.submit();
}
</SCRIPT>  
</body>
