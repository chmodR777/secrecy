...
<input type="hidden" name="strMemTypeID">
<syntc:ScriptsCommon />
<syntc:TitleHeader header="患者信息管理 >> 新建" />
<syntc:FuncHeader header="患者信息新建" showall="yes"/>
<br>
...
<syntc:HtmlTable>
  <tr>
	...
	<td class="input" width="30%" nowrap>
      <input type="text" name="strMemCode">
      <font color="red">*</font>
    </td>
  ...
  <tr>
	...
	<td class="input">
	  <input type="text" name="strMobile">
	  <font color="red">*</font>
    </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<td class="input">
      <input type="text" name="strIDCard">
    </td>
  </tr>
</syntc:HtmlTable>
</form>
...
function checkSubmit() {
	...
	form1.strMemTypeID.value = document.all.strMemType.options[0].value;
	<%} %>
...
function funSave() {
    if (checkSubmit()) {
        document.form1.action = "PatientAddSave.do";
