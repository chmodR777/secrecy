...
<syntc:ScriptsCommon />
<syntc:TitleHeader header="患者信息管理 >> 病历信息管理 >> 修改" />
<syntc:FuncHeader header="病历信息修改" showall="yes"/>
<br>
...
<syntc:HtmlTable>
  <tr>
	...
	<td class="input" width="30%" nowrap>
      <input type="text" name="strCode" value="<%=strCode%>">
      <font color="red">*</font>
    </td>
  ...
  <tr>
	...
	<td class="input">
      <input type="text" name="strMoney" value="<%=strMoney%>">
      <font color="red">*</font>
    </td>
    <td class="item" nowrap>就诊时间：</td>
	<td class="input">
      <syntc:DateImg element="strDate" value="<%=strDate%>"/>
      <font color="red">*</font>
    </td>
  </tr>
  <tr>
    ...
    <td class="input" colspan="3">
      <textarea name="strIll" rows="15" cols="90"><%=strIll%></textarea>
    </td>
  </tr>
</syntc:HtmlTable>
</form>
...
function funSave() {
    if (checkSubmit()) {
        document.form1.action = "IllModifySave.do?patient_id=<%=str_PatientID%>&ill_id=<%=strID%>";
